# COKACENC Rust Build System 사용 설명서
...
| `cokacenc-macos-aarch64` | macOS Apple Silicon (M1/M2/M3/M4) |
...
└── dist/                 # 빌드 결과물
    ├── cokacenc-linux-aarch64
    ├── cokacenc-linux-x86_64
    ├── cokacenc-macos-aarch64
    └── cokacenc-macos-x86_64
```
