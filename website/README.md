...
Marketing and documentation website for [COKACENC](https://github.com/kstost/cokacenc) - a multi-panel terminal file manager written in Rust.

**Live Site:** [https://cokacenc.cokac.com](https://cokacenc.cokac.com)
...
The `CNAME` file in the parent directory configures the custom domain `cokacenc.cokac.com` for GitHub Pages.
...
- [COKACENC Main Repository](https://github.com/kstost/cokacenc) - The Rust file manager
- [Live Demo](https://cokacenc.cokac.com) - Production website
