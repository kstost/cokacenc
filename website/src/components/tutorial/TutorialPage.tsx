        ...
        <div className="max-w-7xl mx-auto px-4 h-16 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <Link to="/" className="hidden sm:block">
              <span className="gradient-text font-bold text-lg">cokacenc</span>
            </Link>
          </div>
          ...
          >
            ...
            <div className="mb-12">
              ...
              <p className="text-lg text-zinc-400 leading-relaxed max-w-3xl">
                {t(
                  'A step-by-step guide for first-time cokacenc users. Follow along from installation to advanced features, or jump to any topic from the sidebar.',
                  'cokacenc를 처음 사용하는 분을 위한 단계별 안내서입니다. 설치부터 고급 기능까지, 순서대로 따라하거나 왼쪽 목차에서 원하는 항목을 골라 읽을 수 있습니다.'
                )}
              </p>
            </div>
