        ...
        <>
          ...
          <div className="bg-bg-card border border-zinc-800 rounded-lg p-4 mb-4">
            ...
            <p className="text-zinc-400 text-sm leading-relaxed">
              ...
              프로그램을 띄우고 <strong className="text-zinc-300">cokacenc로 즉시 복귀</strong>합니다.
              ...
              종료 후 cokacenc로 돌아옵니다. (예: vim, nano, less 등)
            </p>
          </div>
          ...
          <TipBox>
            ...
            설정은 자동 저장되어 cokacenc를 재시작해도 유지됩니다.
          </TipBox>
        </>
      ) : (
        <>
          ...
          <div className="bg-bg-card border border-zinc-800 rounded-lg p-4 mb-4">
            ...
            <p className="text-zinc-400 text-sm leading-relaxed">
              ...
              launches the program and <strong className="text-zinc-300">returns to cokacenc immediately</strong>.
              ...
              cokacenc resumes after the program exits. (e.g., vim, nano, less)
            </p>
          </div>
          ...
          <TipBox>
            ...
            Settings are saved automatically and persist across cokacenc sessions.
          </TipBox>
        </>
      )}
    </section>
