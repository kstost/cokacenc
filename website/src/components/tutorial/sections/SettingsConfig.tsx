      ...
      {lang === 'ko' ? (
        <>
          <p className="text-zinc-400 mb-6 leading-relaxed">
            cokacenc의 외관이나 동작 방식을 취향에 맞게 바꿀 수 있습니다.
          ...
          <p className="text-zinc-400 mb-4">
            cokacenc의 색상 조합을 바꿀 수 있습니다. 기본 테마가 마음에 안 들면 다른 테마로 바꿔보세요.
          </p>
          <p className="text-zinc-400 mb-4">
            테마 파일은 cokacenc를 처음 실행할 때 자동으로 생성됩니다.
            위치는 <code className={codeStyle}>~/.cokacenc/themes/</code> 폴더입니다.
          </p>
          ...
          <p className="text-zinc-400 mb-4">
            cokacenc의 모든 단축키를 원하는 키로 바꿀 수 있습니다.
            설정 파일(<code className={codeStyle}>~/.cokacenc/settings.json</code>)의
          ...
          <StepByStep steps={[
            {
              ...
              description: (
                <span>
                  cokacenc에서 <code className={codeStyle}>~/.cokacenc/</code> 폴더로 이동한 뒤
  ...
  "keybindings": {
    "file_panel": {
      "quit": ["ctrl+q", "ctrl+w"]
          ...
          <TipBox variant="note">
            설정은 <code className={codeStyle}>~/.cokacenc/</code> 폴더에
            저장되어 다음에 cokacenc를 실행할 때도 유지됩니다.
          </TipBox>
        </>
      ) : (
        <>
          <p className="text-zinc-400 mb-6 leading-relaxed">
            Customize cokacenc's appearance and behavior to your liking.
          ...
          <p className="text-zinc-400 mb-4">
            Change cokacenc's color scheme. If you don't like the default theme, try a different one.
          </p>
          <p className="text-zinc-400 mb-4">
            Theme files are automatically generated when you first run cokacenc.
            They're located in the <code className={codeStyle}>~/.cokacenc/themes/</code> folder.
          </p>
          ...
          <p className="text-zinc-400 mb-4">
            Every keyboard shortcut in cokacenc can be remapped to any key you prefer.
            Edit the <code className={codeStyle}>keybindings</code> section
            in <code className={codeStyle}>~/.cokacenc/settings.json</code>.
          </p>
          ...
          <StepByStep steps={[
            {
              ...
              description: (
                <span>
                  Navigate to <code className={codeStyle}>~/.cokacenc/</code> in cokacenc,
  ...
  "keybindings": {
    "file_panel": {
      "quit": ["ctrl+q", "ctrl+w"]
          ...
          <TipBox variant="note">
            Settings are saved in the <code className={codeStyle}>~/.cokacenc/</code> folder
            and persist across cokacenc sessions.
          </TipBox>
        </>
      )}
    </section>
