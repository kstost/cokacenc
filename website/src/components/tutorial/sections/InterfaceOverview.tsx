      ...
      {lang === 'ko' ? (
        <>
          <p className="text-zinc-400 mb-6 leading-relaxed">
            cokacenc를 실행하면 여러 정보가 한 화면에 표시됩니다. 처음에는 복잡해 보일 수 있지만,
        ...
        <>
          <p className="text-zinc-400 mb-6 leading-relaxed">
            When you launch cokacenc, you'll see lots of information on one screen. It might look complex at first,
