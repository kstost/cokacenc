...
#
# COKACENC Installer
# Usage: curl -fsSL https://cokacenc.cokac.com/install.sh | bash
#

set -e

BINARY_NAME="cokacenc"
BASE_URL="https://cokacenc.cokac.com/dist"
...
main() {
    ...
    info "Downloading cokacenc ($os-$arch)..."
    ...
    if [ -x "$install_path" ]; then
        ...
        success "Installed! Run 'cokacenc' to start."
    else
